                        ...
                        return (
                                <div  key={index}>
                                  ...
                                  <h2>{ place.name }</h2>
                                    ...
                                    <p><span>Ville : { place.nameCity }</span></p>
                                    ...
                                    <div className="Detailes">
                                        <h2>Detailes</h2>
                                        <p><strong>Rooms number:</strong> {place.rooms}</p>
                                        <p><strong>BathRooms number:</strong> {place.bathroom}</p>
                                        <p><strong>max geusts:</strong> {place.max_gursts}</p>
